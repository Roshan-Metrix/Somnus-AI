...
--
-- Class JournalInsight as table journal_insights
--
...
--
-- Class JournalPrompt as table journal_prompts
--
...
--
-- Class SleepInsight as table sleep_insights
--
...
--
-- Class SleepSession as table sleep_sessions
--
CREATE TABLE "sleep_sessions" (
    ...
    "deepSleepDuration" bigint,
    "lightSleepDuration" bigint,
    "remSleepDuration" bigint,
    "awakeDuration" bigint,
    "restingHeartRate" bigint,
    "hrv" bigint,
    "respiratoryRate" bigint,
    "interruptions" bigint,
    "sleepDataSource" text,
    "deviceType" text,
    "deviceModel" text,
    "recordingMethod" text,
    "timeInBedMinutes" bigint,
    "sleepEfficiency" double precision,
    "unspecifiedSleepDuration" bigint,
    "wristTemperature" double precision
);
...
--
-- Class ThoughtLog as table thought_logs
--
...
CREATE TABLE "users" (
    ...
    "sleepInsightsEnabled" boolean NOT NULL,
    "sleepInsightsTime" text,
    "journalInsightsEnabled" boolean NOT NULL,
    "journalInsightsTime" text,
    "createdAt" timestamp without time zone NOT NULL
);
